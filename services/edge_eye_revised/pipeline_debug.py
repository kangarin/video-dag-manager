...
import super_resolution_pos_calculation
import edge_observe
...
if __name__ == '__main__':
    ...
    sr_and_pc = super_resolution_pos_calculation.SuperResolutionPosCalculation(args)
    ...
    while ret:
        ...
        # print('stage 3')
        start23 = time.time()
        output_ctx23 = sr_and_pc(output_ctx1)
        end23 = time.time()
        print('time of stage 2 and 3: {}'.format(end23 - start23))

        start4 = time.time()
        output_ctx4 = edge_observer(output_ctx23)
        end4 = time.time()
